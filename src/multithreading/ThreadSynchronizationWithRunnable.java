...
public class ThreadSynchronizationWithRunnable {

    public static void main(String[] args) {
        BankAccount account = new BankAccount(0);

        Thread withdrawThread = new Thread(new WithdrawThread(account,5000));
        Thread thread1 = new Thread(new DepositThread(account, 5000));
        Thread thread2 = new Thread(new DepositThread(account, 2000));
